package com.example.assets.web.dto.generated;
...
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen", date = "2025-08-26T03:38:10.177868900+02:00[Europe/Madrid]", comments = "Generator version: 7.10.0")
public class AssetFileUploadRequest {
   ...
   */
  @NotNull @Size(min = 1) 
  @Schema(name = "encodedFile", example = "[B@e154848", description = "The actual file content encoded in Base64 format. Maximum size after decoding: 50MB", requiredMode = Schema.RequiredMode.REQUIRED)
